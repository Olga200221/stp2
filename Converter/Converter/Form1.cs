...
namespace Converter
{
	public partial class Form1 : Form
	{
		...
		private void UpdateP2()
		{
			...
			doCmnd(Editor.Commands.exec); // ✔ ИСПРАВЛЕНИЕ
		}
		...
		private void историяToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < control_.history.Count(); i++)
			{
				...
				history.dataGridView1.Rows.Add(
					currentRecord[0],
					currentRecord[1],
					currentRecord[2],
					currentRecord[3]);
		...
		private void Form1_KeyPress(object sender, KeyPressEventArgs e)
		{
			...
			doCmnd((Editor.Commands)
				Enum.GetValues(typeof(Editor.Commands)).GetValue(i));
		}
		...
		private void button_Click(object sender, EventArgs e)
		{
			...
			doCmnd((Editor.Commands)
				Enum.GetValues(typeof(Editor.Commands)).GetValue(j));
		}
	}
}
